...
export class basicCampaign1597671781673 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "campaign_characters_character" ("campaignId" integer NOT NULL, "characterId" character varying NOT NULL, CONSTRAINT "PK_cc4b8ca429f019fac2feb1ef1bc" PRIMARY KEY ("campaignId", "characterId"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_76e4c252bca117e89bb082c035" ON "campaign_characters_character" ("campaignId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_ba8d6a207297d9c998fbf67dfa" ON "campaign_characters_character" ("characterId") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "campaign_characters_character" ADD CONSTRAINT "FK_ba8d6a207297d9c998fbf67dfa2" FOREIGN KEY ("characterId") REFERENCES "character"("uid") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
