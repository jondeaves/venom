...
export class addCharGameState1597840524273 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "player_characters_character" ("playerUid" character varying NOT NULL, "characterId" character varying NOT NULL, CONSTRAINT "PK_581ee5a2f9c6e16839f0e255661" PRIMARY KEY ("playerUid", "characterId"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_f654f2fd12d3237e520f6acab4" ON "player_characters_character" ("playerUid") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_44a60bba30ecded9502e3602c0" ON "player_characters_character" ("characterId") `,
    );
    await queryRunner.query(`ALTER TABLE "character" ADD "gameState" integer`);
    await queryRunner.query(`UPDATE "character" SET "gameState" = 1`);
    await queryRunner.query(`ALTER TABLE "character" ALTER COLUMN "gameState" SET NOT NULL`);
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "player_characters_character" ADD CONSTRAINT "FK_44a60bba30ecded9502e3602c0c" FOREIGN KEY ("characterId") REFERENCES "character"("uid") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TABLE "player" CASCADE`);
  }
}
